...
// Создать интерфейс SimpleList, 
//который определяет методы динамического массива, 
//предназначенного для хранения строк:
public interface SimpleList {
	void add(String s); //добавляет строку в массив
